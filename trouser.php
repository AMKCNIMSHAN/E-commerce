...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="images/OI (1).jpeg" width="100%" id="ProductImg">


            <div class="small-img-row">
          
                <div class="small-img-col">
                    <img src="images/OI (1).jpeg" width="100%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/OI (2).jpeg" width="100%" class="small-img">
                </div>
                <div class="small-img-col">
                    <img src="images/OI (3).jpeg" width="100%" class="small-img">
                </div>
                <div class="small-img-col"> 
                    <img src="images/OI.jpeg" width="100%" class="small-img">
                </div>
            </div>
        </div>
        <div class="col-2">
          
            <h1 style="font-weight: bold;">Trousers by enjoy dude.</h1>
